...
Нелинейные паттерны не были единственным отличием ПМ в HOPE от обычного современного ПМ в ФЯ. Сопоставление с единственным конструктором типа данных, например, такого вида `(a, b) = ...` соответствовало `~(a, b) = ....` в Haskell. К тому же - никаких `@`-паттернов.   
